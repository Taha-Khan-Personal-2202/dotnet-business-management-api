...
namespace DotNetBusinessWorkFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260208041337_AddedInvoiceItemTable")]
    partial class AddedInvoiceItemTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetBusinessWorkFlow.Domain.Entities.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DotNetBusinessWorkFlow.Domain.Entities.InvoiceItem", b =>
                {
                    b.HasOne("DotNetBusinessWorkFlow.Domain.Entities.Invoice", null)
                        .WithMany("Items")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("DotNetBusinessWorkFlow.Domain.ValueObjects.Money", "TotalPrice", b1 =>
                        {
